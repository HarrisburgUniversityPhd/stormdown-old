...
Then you can style the table with the `kable` function, or functions in the [kableExtra](https://cran.r-project.org/web/packages/kableExtra/index.html) pacakge. 
...
Recall the `flights` dataset from Chapter \@ref(rmd-basics).
...
For example, at the top of the Rmd file for this chapter, you can see:
