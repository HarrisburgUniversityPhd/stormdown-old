...
<!--
The bib chunk below must go last in this document according to how R Markdown renders.
...
Add other entries into the list here if you'd like them to appear in the bibliography even if they weren't explicitly cited in the document.
-->
