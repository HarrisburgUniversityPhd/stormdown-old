...
# This chunk ensures that the stormdown package is
# installed and loaded. This stormdown package includes
# the template files for the dissertation.
if(!require(devtools))
  install.packages("devtools", repos = "http://cran.rstudio.com")
if(!require(stormdown))
